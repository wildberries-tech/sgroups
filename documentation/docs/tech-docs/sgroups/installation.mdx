...
<TabItem value='docker'>
  ...
  ```
  <dev>
    Создаем конфигурационный файл для hbf-server командой:
  </dev>
  ...
  <dev>
    Собираем образ hbf-server воспользовавшись уже готовым Dockerfile командой:
  </dev>
...
{' '}
  ...
  ```
  <dev>
    Создаем конфигурационный файл для hbf-server.service командой:
  </dev>
