  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Включить/Отключить возможность получения информации о статусе hbf-сервера по `/healthcheck`.</td>
        <td>String</td>
        <td></td>
      ...
      <tr>
        <td>`storage.type`</td>
        <td>Подключаемый тип базы данных. Допустимые значения: `internal`, `postgres`.</td>
        <td>String</td>
        <td></td>
