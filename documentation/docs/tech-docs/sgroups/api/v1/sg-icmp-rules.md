...
<ul>
    <li>если в теле запроса указать одно или более sg - значений из имён источников Security Groups (sg), то получим ответ по указанным SG:ICMP правилам</li>
    <li>если в теле запроса указать пустой массив sgFrom или пустое тело запроса, то получим ответ со всеми существующими SG:ICMP правилами</li>
