...
<ul>
  <li>Этот метод отображает список Security Group to CIDR правил, в соответствии с указанным списком Security Groups.</li>
</ul>

<div className="text-justify">
  Более подробно по организации БД можно посмотреть [здесь](../../database.mdx).
</div>
