...
<ul>
  <li className="text-justify">
    если в теле запроса указано одно или более значений в обоих массивах Sg -> Sg_local, то получим ответ всех
    существующих комбинаций правил IE-SG-SG-ICMP каждого указанного значения Sg с каждым указанным значением Sg_local
    (value-to-value)
  </li>
  <li className="text-justify">
  ...
  <li className="text-justify">
    если в теле запроса указаны пустые массивы Sg -> Sg_local, то получим ответ всех существующих комбинаций правил
