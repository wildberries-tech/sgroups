...
<div className="paragraph">
  В качестве инструмента для миграции базы данных использует <i>goose</i>. Когда в качестве хранилища используется Postgres, goose запускается
  перед началом работы hbf-server'a. Более подробную информацию о <i>goose</i> можно найти [здесь](https://github.com/pressly/goose).
</div>
