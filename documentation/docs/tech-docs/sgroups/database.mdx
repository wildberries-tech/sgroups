    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <ul>
            <li>
              [Отобразить список IE-SG-SG-ICMP правил для входящего и исходящего
              траффика](./api/v1/ie-sg-sg-icmp-rules.mdx)
            </li>
            <li>[Внести изменения в БД](./api/v1/sync.mdx)</li>
          </ul>
        </td>
      ...
      <tr>
        ...
        <td>
          <ul>
            <li>
              [Отобразить список правил SG-SG:ICMP ограниченных по типу SG from -> to](./api/v1/sg-sg-icmp-rules.md)
            </li>
            <li>[Внести изменения в БД](./api/v1/sync.mdx)</li>
          </ul>
        </td>
