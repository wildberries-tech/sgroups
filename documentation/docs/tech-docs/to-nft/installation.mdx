  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          Включить/Отключить возможность получения информации о статусе hbf-агента. Значение по умолчанию: `true`. Пример получения метрик: `curl 0.0.0.0:9660/healthcheck`.
        </td>
        <td>Boolean</td>
        <td>Нет</td>
      ...
      <tr>
        ...
        <td>Включить/Отключить возможность получения профиля hbf-агента. Значение по умолчанию: `true`. Пример получения метрик: `curl 0.0.0.0:9660/debug/pprof/goroutine?debug=2`.</td>
        <td>Boolean</td>
        <td>Нет</td>
