  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>Boolean</td>
        <td>Нет</td>
        <td>NFT_EXIT_ON_SUCCESS</td>
      </tr>
      <tr>
        <td>`continue-on-failure`</td>
        <td>В случае ошибки на уровне job, агент не завершает свою работу (идет на цикл перезапуска своих job). Значение по умолчанию: `true`</td>
        <td>Boolean</td>
        <td>Нет</td>
        <td>NFT_CONTINUE_ON_FAILURE</td>
      </tr>
      <tr>
        <td>`logger.level`</td>
        ...
        <td>String</td>
        <td>Нет</td>
        <td>NFT_LOGGER_LEVEL</td>
      </tr>
      <tr>
        <td>`graceful-shutdown`</td>
        <td>Определяет период времени, в течение которого процесс агента должен корректно завершиться. По истечению периода, процесс завершиться с кодом 1. Значение по умолчанию: `10s`</td>
        <td>String</td>
        <td>Нет</td>
        <td>NFT_GRACEFUL_SHUTDOWN</td>
      </tr>
      <tr>
        <td>`netns`</td>
      ...
      <tr>
        ...
        <td>String</td>
        <td></td>
        <td>NFT_NETLINK_WATCHER_LINGER</td>
      </tr>
      <tr>
        <td>`base-rules.networks`</td>
        <td>Список IP адресов, к которым всегда должен egress быть доступ. Не рекомендуется устанавливать в качестве значения пустой список.</td>
        <td>List</td>
        <td>Да</td>
        <td>NFT_BASE_RULES_NETWORKS</td>
      </tr>
      <tr>
        <td>`fqdn-rules.strategy`</td>
        <td>Способ обработки fqdn-правил. Значение по умолчанию: `dns`. Допустимые значения: `dns`, `ndpi`, `combine`. </td>
        <td>String</td>
        <td>Нет</td>
        <td>NFT_FQDN_RULES_STRATEGY</td>
      </tr>
      <tr>
        ...
        <td>List</td>
        <td>Да</td>
        <td>NFT_DNS_NAMESERVERS</td>
      </tr>
      <tr>
        <td>`dns.proto`</td>
        <td>Протокол L4, используемый DNS сервером. Значение по умолчанию: `udp`. Допустимые значения: `udp`, `tcp`.</td>
        <td>String</td>
        <td>Да</td>
        <td>NFT_DNS_PROTO</td>
      </tr>
      ...
      <tr>
        ...
        <td>String</td>
        <td>Нет</td>
        <td>NFT_DNS_DIAL_DURATION</td>
      </tr>
      <tr>
        <td>`dns.write-duration`</td>
        <td>Максимальное временя ожидания ответа от DNS сервера при запросе резолва FQDN. Значение по умолчанию: `5s`.</td>
        <td>String</td>
        <td>Нет</td>
        <td>NFT_DNS_WRITE_DURATION</td>
      </tr>
      <tr>
        ...
        <td>String</td>
        <td>Нет</td>
        <td>NFT_DNS_READ_DURATION</td>
      </tr>
      <tr>
        <td>`extapi.svc.def-dial-duration`</td>
        <td>Длительность ожидания подключения к службе.</td>
        <td>String</td>
        <td>Нет</td>
        <td>NFT_EXTAPI_SVC_DEF_DIAL_DURATION</td>
      </tr>
      <tr>
        ...
        <td>String</td>
        <td>Да</td>
        <td>NFT_EXTAPI_SVC_SGROUPS_ADDRESS</td>
      </tr>
      <tr>
        ...
        <td>String</td>
        <td>Нет</td>
        <td>NFT_EXTAPI_SVC_SGROUPS_DIAL_DURATION</td>
      </tr>
      <tr>
        ...
        <td>String</td>
        <td>Да</td>
        <td>NFT_EXTAPI_SVC_SGROUPS_SYNC_STATUS_INTERVAL</td>
      </tr>
      <tr>
        ...
        <td>Boolean</td>
        <td>Нет</td>
        <td>NFT_EXTAPI_SVC_SGROUPS_SYNC_STATUS_PUSH</td>
      </tr>
      <tr>
        ...
        <td>String</td>
        <td>Нет</td>
        <td>NFT_TELEMETRY_ENDPOINT</td>
      </tr>
      <tr>
        <td>`telemetry.metrics.enable`</td>
        <td>Включить/Отключить возможность получения метрик (метрики доступны по `/metrics`). Значение по умолчанию: `true`.</td>
        <td>Boolean</td>
        <td>Нет</td>
        <td>NFT_TELEMETRY_METRICS_ENABLE</td>
      </tr>
      <tr>
        <td>`telemetry.healthcheck.enable`</td>
        <td>Включить/Отключить возможность получения информации о статусе hbf-агента по `/healthcheck`. Значение по умолчанию: `true`.</td>
        <td>Boolean</td>
        <td>Нет</td>
        <td>NFT_TELEMETRY_HEALTHCHECK_ENABLE</td>
      </tr>
      <tr>
        ...
        <td>String</td>
        <td>Нет</td>
        <td>NFT_TELEMETRY_USERAGENT</td>
      </tr>
      <tr>
        <td>`telemetry.profile.enable`</td>
        <td>Позволяет получать профиль агента по `/debug/pprof/index`. Значение по умолчанию: `true`.</td>
        <td>Boolean</td>
        <td>Нет</td>
        <td>NFT_TELEMETRY_PROFILE_ENABLE</td>
      </tr>
    </tbody>
  </table>
</div>