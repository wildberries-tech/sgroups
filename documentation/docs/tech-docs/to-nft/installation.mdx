  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          Включить/Отключить возможность получения метрик (метрики доступны по `/metrics`). Значение по умолчанию:
          `true`.
        </td>
        <td>Boolean</td>
        <td>Нет</td>
      ...
      <tr>
        ...
        <td>
          Включить/Отключить возможность получения информации о статусе hbf-агента по `/healthcheck`. Значение по
          умолчанию: `true`.
        </td>
        <td>Boolean</td>
        <td>Нет</td>
