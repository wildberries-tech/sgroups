...
<div class="paragraph">
  Правило E:S2F (Egress Security Group to FQDN) предоставляет возможность гибкого управления и контроля за сетевым
  трафиком между различными группами безопасности и FQDN записями, используя TCP, UDP протоколы. Это правило дает
