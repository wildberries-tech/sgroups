...
<div class="paragraph">
  Правило E:S2F (Egress Security Group to FQDN) предоставляет возможность
  гибкого управления и контроля за сетевым трафиком между различными группами
  безопасности и FQDN записями, используя TCP, UDP протоколы. Это правило дает
  возможность детально настроить, какой трафик разрешен к передаче между
  группами безопасности и определенными FQDN записями, тем самым гарантируя
...
>
    ...
    <TabItem value="api">
        <div class="text-justify">
            ...
            Более подробно по организации БД можно посмотреть [здесь](../sgroups/database.md#tbl_fqdn_rule)
        </div>
