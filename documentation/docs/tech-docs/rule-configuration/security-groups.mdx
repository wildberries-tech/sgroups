...
>
    ...
    <TabItem value="api">
        ...
        <ul>
            <li class="text-justify">`groups.groups[].name`:</li>
                <ul>
                    <li class="text-justify">Длина значения не должна превышать 256 символов.</li>
                    <li class="text-justify">Значение должно начинаться и заканчиваться символами без пробелов.</li>
                </ul>
            <li class="text-justify">`groups.groups[].networks[]`:</li>
                <ul>
                    <li class="text-justify">Длина каждого значения элемента из списка не должна превышать 256 символов.</li>
                    <li class="text-justify">Значение каждого элемента из списка должно начинаться и заканчиваться символами без пробелов.</li>
                    <li class="text-justify">Повторения значений в списке не допускаются.</li>
                </ul>                
            <li class="text-justify">`sgIcmpRules.rules[].Sg`:</li>
                <ul>
                    <li class="text-justify">Длина значения не должна превышать 256 символов.</li>
                    <li class="text-justify">Значение должно начинаться и заканчиваться символами без пробелов.</li>
                </ul>                
            <li class="text-justify">`$node.rules[].type[]`:</li>
                <ul>
                    <li class="text-justify">Значение каждого элемента список должно быть числом в диапазоне от 0 до 255.</li>
                    <li class="text-justify">Повторения значений в списке не допускаются.</li>
                </ul>
        </ul>
