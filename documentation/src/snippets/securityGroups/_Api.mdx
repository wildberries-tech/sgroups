...
import { ERRORCODES } from '@site/src/constants/errorCodes.tsx'
...
<TabItem value="sg">
<details>
  <summary>{ERRORCODES.apiTypo.summary}</summary>

  {ERRORCODES.apiTypo.body}
</details>

<details>
  <summary>{ERRORCODES.sgNotExist.summary}</summary>

  {ERRORCODES.sgNotExist.body}
</details>

<details>
  <summary>{ERRORCODES.sgTypo.summary}</summary>

  {ERRORCODES.sgTypo.body}
</details>

<details>
  <summary>{ERRORCODES.sPortsIntersection.summary}</summary>

  {ERRORCODES.sPortsIntersection.body}
</details>

<details>
  <summary>{ERRORCODES.syncopTypo.summary}</summary>

  {ERRORCODES.syncopTypo.body}
</details>
