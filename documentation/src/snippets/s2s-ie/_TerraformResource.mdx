        ...
        <div className="parent-div">
            <div className="child-block">
                ...
                resource "sgroups_ie_rules" "rules" {
                    items = {
                    "tcp:sg_local(sg-local-example)sg(sg-example)ingress" = {
                        traffic     = "ingress"
                        transport   = "tcp"
                        sg          = "sg-example"
            ...
            <div className="child-block">
                ...
                resource "sgroups_ie_rules" "rules" {
                    items = {
                    "tcp:sg_local(sg-local-example)sg(sg-example)egress" = {
                        traffic     = "egress"
                        transport   = "tcp"
                        sg          = "sg-example"
                        sg_local    = "sg-local-example"
    ...
    <TabItem value="udp">
        <div className="parent-div">
            <div className="child-block">
                ...
                resource "sgroups_ie_rules" "rules" {
                    items = {
                    "udp:sg_local(sg-local-example)sg(sg-example)ingress" = {
                        traffic     = "ingress"
                        transport   = "udp"
                        sg          = "sg-example"
                        sg_local    = "sg-local-example"
            ...
            <div className="child-block">
                ...
                resource "sgroups_ie_rules" "rules" {
                    items = {
                    "udp:sg_local(sg-local-example)sg(sg-example)egress" = {
                        traffic     = "egress"
                        transport   = "udp"
                        sg          = "sg-example"
                        sg_local    = "sg-local-example"
