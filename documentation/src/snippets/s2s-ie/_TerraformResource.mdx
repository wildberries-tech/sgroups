        ...
        <div className="parent-div">
            <div className="child-block">
                ...
                resource "sgroups_ie_rules" "rules" {
                    items = {
                    "tcp:sg_local(sg_local_example)sg(sg_example)ingress" = {
                        traffic     = "ingress"
                        transport   = "tcp"
                        sg          = "sg_example"
            ...
            <div className="child-block">
                ...
                resource "sgroups_ie_rules" "rules" {
                    items = {
                    "tcp:sg_local(sg_local_example)sg(sg_example)egress" = {
                        traffic     = "egress"
                        transport   = "tcp"
                        sg          = "sg_example"
                        sg_local    = "sg_local_example"
    ...
    <TabItem value="udp">
        <div className="parent-div">
            <div className="child-block">
                ...
                resource "sgroups_ie_rules" "rules" {
                    items = {
                    "udp:sg_local(sg_local_example)sg(sg_example)ingress" = {
                        traffic     = "ingress"
                        transport   = "udp"
                        sg          = "sg_example"
                        sg_local    = "sg_local_example"
            ...
            <div className="child-block">
                ...
                resource "sgroups_ie_rules" "rules" {
                    items = {
                    "udp:sg_local(sg_local_example)sg(sg_example)egress" = {
                        traffic     = "egress"
                        transport   = "udp"
                        sg          = "sg_example"
                        sg_local    = "sg_local_example"
        ...
        <div className="parent-div">
            <div className="child-block">
                ...
                resource "sgroups_icmp_rules" "rules" {
                    items = {
                    "icmp4:sg_local(sg-example-local)sg(sg-example)ingress" = {
                        logs    = true
                        trace   = true
                    ...
                    "icmp6:sg_local(sg-example-local)sg(sg-example)ingress" = {
                        logs    = true
                        trace   = true
                        sg_local = sg-example-local
                        sg       = sg-example
            ...
            <div className="child-block">
                ...
                resource "sgroups_icmp_rules" "rules" {
                    items = {
                    "icmp4:sg_local(sg-example-local)sg(sg-example)egress" = {
                        logs    = true
                        trace   = true
                        sg_local = sg-example-local
                        sg       = sg-example
                    ...
                    "icmp6:sg_local(sg-example-local)sg(sg-example)egress" = {
                        logs    = true
                        trace   = true
                        sg_local = sg-example-local
                        sg       = sg-example
