...
<h4 className="custom-heading"><a href='https://github.com/H-BF/swarm-spec-template/blob/master/spec/sg-local-example.yaml#L144'>Пример использования</a></h4>
...
>
    <TabItem value="tcp">
        <div className="parent-div" style={{height: "420px"}}>
